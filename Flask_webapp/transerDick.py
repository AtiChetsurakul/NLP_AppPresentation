...
v = [line.rstrip() for line in open('copTrans/vocabjjngu.txt', mode='r')]
# print('Vocab Size check', len(v)) #not work
with open('copTrans/vocabjjngu.atikeep', 'rb') as handle:
...
model.load_state_dict(torch.load(
    '/Users/atichetsurakul/Desktop/JAN23/nlp123clone/NLP_AppPresentation/Flask_webapp/copTrans/predictor_weight.pt'))
